    ...
    <div class="container py-5 py-lg-0">
      <div class="row align-items-center">
        <div class="col-lg-4 wow zoomIn">
          <div class="img-banner d-none d-lg-block" style="padding-right:700px;">
            <img src="../assets/img/computer.png" style="width:500px;" alt="">
          </div>
        </div>
        <div class="col-lg-8 wow fadeInRight" style="padding-left:120px;">
          <h1 class="font-weight-normal mb-3">Schedule an appointment using AppointMed Website</h1>
          <h1 class="font-weight-normal mb-3" style="font-size:20px">visit us at www.apptmed.com</h1>
        </div>
      </div>
    </div>
  </div> <!-- .banner-home -->
      ...
      <div class="row px-md-3">
        <div class="col-sm-6 col-lg-3 py-3">
          ...
          <div class="footer-sosmed mt-3">
            <a href="https://www.facebook.com/Med-Assis-110405315002836" target="_blank"><span class="mai-logo-facebook-f"></span></a>
            <a href="https://twitter.com/ApptMed" target="_blank"><span class="mai-logo-twitter"></span></a>
            <a href="https://gmail.com/" target="_blank"><span class="mai-logo-google-plus-g"></span></a>
            <a href="https://www.instagram.com/apptmed/" target="_blank"><span class="mai-logo-instagram"></span></a>
          </div>
        </div>
      </div>
      <hr>
      <p id="copyright">Copyright &copy; 2022 <a href="https://macodeid.com/" target="_blank">Trinity Force</a>. All right reserved</p>
    </div>
  </footer>
